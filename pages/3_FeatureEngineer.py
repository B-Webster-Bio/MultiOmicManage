...
st.markdown('Together with our 4 gas exchange traits and 2 agronomic traits we have a lot to work with. On this page fit XGBoost models with different sets of features to try and predict yield.')
...
feature_set_options = {
    "Agronomic: GasEx + Field)": agron_features,
    "GasEx": gas_ex_features,
    'Field: Plant Ht and Flowering': field_features,
